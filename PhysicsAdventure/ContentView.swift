            ...
            VStack(spacing: 24) {
                ...
                ScrollView {
                    VStack(spacing: 16) {
                        ...
                        VStack(spacing: 12) {
                            Text("Astronomy Zone").font(.headline).foregroundStyle(.secondary)
                            NavigationLink("Level 1: Orbital Mechanics") {
                                OrbitalMechanicsChallenge()
                            }
                            .buttonStyle(.borderedProminent)
                            .tint(.purple)

                            NavigationLink("Level 2: Stellar Evolution") {
                                StellarEvolutionChallenge()
                            }
                            .buttonStyle(.borderedProminent)
                            .tint(.purple)

                            NavigationLink("Level 3: Gravitational Lensing") {
